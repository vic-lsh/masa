...
#[cfg(feature = "rajomon")]
const TOKENS_LEFT_INIT: u64 = 500; // original: tokensLeft (10)
#[cfg(feature = "rajomon")]
const TOKEN_UPDATE_RATE_MS: u64 = 10; // original: tokenUpdateRate (10ms)
#[cfg(feature = "rajomon")]
const TOKEN_UPDATE_STEP: u64 = 10; // original: tokenUpdateStep (1)
#[cfg(feature = "rajomon")]
const MAX_TOKEN: u64 = 500; // original: maxToken (10)
