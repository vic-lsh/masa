...
impl Client for SynthbenchClient {
...
enum RequestHandler {
    ARequest(Handler<ARequest, SynthbenchClient>),
    BRequest(Handler<BRequest, SynthbenchClient>),
}

impl HandlerOuter<SynthbenchClient> for RequestHandler {
...
impl RequestType<SynthbenchClient> for ARequest {
...
impl RequestType<SynthbenchClient> for BRequest {
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    load_gen_main::<RequestHandler, SynthbenchClient>(args, time_now()).await
}
