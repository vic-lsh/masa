...
use synthbench::config::{validate_call_graph, SynthbenchConfig};

#[derive(StructOpt, Debug)]
#[structopt(
    name = "validate_config",
    about = "Validate synthbench experiment configuration"
)]
struct Args {
...
fn main() {
    ...
    // Parse JSON
    let config: SynthbenchConfig = match serde_json::from_reader(reader) {
        Ok(c) => c,
        Err(e) => {
