...
from .orchestrator import launch_replay_from_trace
from .replay_config import ReplayConfig, ReplayConfigError
...
def run_from_alibaba_trace(
    ...
    replay_config = ReplayConfig.from_replicas_path(replicas_path)

    launch_replay_from_trace(
        trace_configs,
        callgraph_dirs,
        replay_config,
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    except (TraceConfigError, ReplayConfigError, ValidationError, RuntimeError) as exc:
