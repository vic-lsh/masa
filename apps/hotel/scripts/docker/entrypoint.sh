...
# Conditionally add the --gen-config flag for the specific binary.
# The '--' separates arguments for 'cargo run' from arguments for the binary itself.
if [ "${BINARY_NAME}" == "hotel_client_bench" ]; then
