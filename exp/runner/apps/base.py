    ...
    def build(
        ...
        *,
        ...
        Args:
            ...
            cpu_affinity: Optional list of CPU cores to bind this build to (for parallel builds)
            log_file: Optional file path to redirect build logs to (for parallel builds)
