...
impl Service<tonic::http::Request<BoxBody>> for LoadBalancedChannel {
    type Response = tonic::http::Response<<Channel as GrpcService<BoxBody>>::ResponseBody>;
