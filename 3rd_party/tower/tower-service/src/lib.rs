...
// impl<Req, S> Service<Req> for S
// where
//     S: DDLService<Req> + NoRef,
// {
//     type Response = S::Response;
//     type Error = S::Error;
//     type Future = S::Future;
...
//         // TODO: in the future, ignore the returned ddl
//         self.call(req)
//     }
// }
//
// impl<'a, S, Request> DDLService<Request> for &'a mut S
// where
//     S: DDLService<Request> + 'a,
// {
//     type Response = S::Response;
//     type Error = S::Error;
//     type Future = S::Future;
...
// }
//
// impl<S, Request> DDLService<Request> for Box<S>
// where
//     S: DDLService<Request> + ?Sized,
// {
//     type Response = S::Response;
//     type Error = S::Error;
//     type Future = S::Future;
